...
RcppExport SEXP _kernelPSI_pvalue(SEXP sampleSEXP, SEXP replicatesSEXP, SEXP KSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< arma::field<arma::mat> >::type K(KSEXP);
    rcpp_result_gen = Rcpp::wrap(pvalue(sample, replicates, K));
    return rcpp_result_gen;
END_RCPP
}
// sampleH
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_kernelPSI_pvalue", (DL_FUNC) &_kernelPSI_pvalue, 3},
