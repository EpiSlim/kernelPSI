...
// sampleF
arma::mat sampleF(arma::field<arma::mat> A, NumericVector initial, int n_replicates, double mu, double sigma, int n_iter, int burn_in);
RcppExport SEXP _kernelPSI_sampleF(SEXP ASEXP, SEXP initialSEXP, SEXP n_replicatesSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP n_iterSEXP, SEXP burn_inSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::field<arma::mat> >::type A(ASEXP);
    ...
    Rcpp::traits::input_parameter< int >::type n_iter(n_iterSEXP);
    Rcpp::traits::input_parameter< int >::type burn_in(burn_inSEXP);
    rcpp_result_gen = Rcpp::wrap(sampleF(A, initial, n_replicates, mu, sigma, n_iter, burn_in));
    return rcpp_result_gen;
END_RCPP
}
// sampleH
...
// sampleQ
arma::mat sampleQ(arma::field<arma::mat> A, NumericVector initial, int n_replicates, double mu, double sigma, int n_iter, int burn_in);
RcppExport SEXP _kernelPSI_sampleQ(SEXP ASEXP, SEXP initialSEXP, SEXP n_replicatesSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP n_iterSEXP, SEXP burn_inSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::field<arma::mat> >::type A(ASEXP);
    ...
    Rcpp::traits::input_parameter< int >::type n_iter(n_iterSEXP);
    Rcpp::traits::input_parameter< int >::type burn_in(burn_inSEXP);
    rcpp_result_gen = Rcpp::wrap(sampleQ(A, initial, n_replicates, mu, sigma, n_iter, burn_in));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_kernelPSI_sampleF", (DL_FUNC) &_kernelPSI_sampleF, 7},
    {"_kernelPSI_sampleH", (DL_FUNC) &_kernelPSI_sampleH, 7},
    {"_kernelPSI_sampleQ", (DL_FUNC) &_kernelPSI_sampleQ, 7},
    {NULL, NULL, 0}
};
